...
const EnableNotifView = ({ navigation }) => {
    ...
    <SafeAreaView>
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          For us to be able to send you {"\n"} notifications, if any recruiter
          sent you{"\n"}a message, or you have a good job{"\n"} oportunity near
        ...
        <View style={styles.btnLoginView}>
          ...
          <TouchableOpacity style={styles.buttonSkip} onPress={() => navigation.navigate('EnableLocation')}>
...
export default EnableNotifView;
